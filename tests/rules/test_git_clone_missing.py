import pytest
from thefeck.rules.git_clone_missing import match, get_new_command
from thefeck.types import Command

valid_urls = [
    'https://github.com/nvbn/thefeck.git',
    'https://github.com/nvbn/thefeck',
    'http://github.com/nvbn/thefeck.git',
    'git@github.com:nvbn/thefeck.git',
    'git@github.com:nvbn/thefeck',
    'ssh://git@github.com:nvbn/thefeck.git',
]
invalid_urls = [
    '',  # No command
    ...
    'git clone https://github.com/nvbn/thefeck.git',  # Full command
    'github.com/nvbn/thefeck.git',  # Missing protocol
    'github.com:nvbn/thefeck.git',  # SSH missing username
    'git clone git clone ssh://git@github.com:nvbn/thefrick.git',  # 2x clone
    'https:/github.com/nvbn/thefeck.git'  # Bad protocol
]
outputs = [
